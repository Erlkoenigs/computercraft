...
local orientation = 0
local path = {}
local max = 0 --maximum forward and upward distance to travel
...
--1.
while not turtle.detectUp() and up < max do
    turtle.up()
    up = up + 1
end

--2.
while not turtle.detect() and fw < max do
    turtle.forward()
    fw = fw + 1
end
